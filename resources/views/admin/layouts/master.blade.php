...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top" {{--style="display: flex; justify-content: space-between;"--}}>
          <!-- Sidebar toggle button-->
          <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
              <span class="sr-only">Toggle navigation</span>
          </a>
        <div class="" style="float: left; position: absolute; left: 5px; top: 7px;">
            <form action="{{ route('logout') }}" method="post">
                @csrf
            <button type="submit" href="{{ route('logout') }}" class="btn btn-block btn-danger">
                خروج از حساب
            </button>
            </form>
        </div>
